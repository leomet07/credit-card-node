<template>
	<div id="card_display" class="disable-copy">
		<div class="Wrap">
			<div class="Base">
				<div class="Inner-wrap">
					...
					<svg
						...
						style="enable-background:new 0 0 97.814 97.063;"
						xml:space="preserve"
					>
						<g id="The_x5F_Chase_x5F_Manhattan_x5F_Bank">
							<path
								...
								d="M31.534,0.148c11.888,0.129,20.426,0,32.226,0c1.625,0,3.551-0.332,4.912,0
		...
		c-8.182,8.494-16.734,16.807-24.918,24.679c-0.192-18.602-0.095-42.894-0.12-65.051C69.098,31.123,69.218,31.003,69.39,30.937z"
							...
							<path
								class="Logo"
								style="fill-rule:evenodd;clip-rule:evenodd;"
								d="M66.515,68.193c0.309,9.83,0.309,19.073,0,28.513
		...
		C23.242,68.233,44.12,68.237,66.515,68.193z"
					...
					<svg
						...
						style="enable-background:new 0 0 387.8 380.3;"
						xml:space="preserve"
					>
						<defs>
							<linearGradient
							...
							<g id="XMLID_6_">
								<g id="XMLID_14_">
									<g id="XMLID_32_">
										<path
											id="XMLID_33_"
											d="M277.4,90.1h-1c-2.5,0-4.5,2-4.5,4.5v272c0,2.5,2,4.5,4.5,4.5h1c2.5,0,4.5-2,4.5-4.5v-272
